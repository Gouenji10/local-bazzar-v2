    ...
    <div class="row">
        <div class="page-header">
            <div class="d-flex align-items-center">
                <h2 class="page-header-title">Custom Taxonomy</h2>
                <div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="db-default.html"><i class="ti ti-home"></i></a></li>
                        <li class="breadcrumb-item"><a href="#">Custom Fields</a></li>
                        <li class="breadcrumb-item active"><a href="#">Taxonomy</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="widget has-shadow">
                <div class="widget-header bordered no-actions d-flex align-items-center" style="justify-content: space-between;">
                    <h2>All Taxonomy</h2>
                    <a href="#off-canvas"class="btn btn-primary open-sidebar"><i class="la la-pencil"></i>Add Taxonomy</a>
                </div>
...
<div class="off-sidebar from-right">
    <div class="off-sidebar-container">
    	<header class="off-sidebar-header">
			<div class="pl-3"><h2>New Taxonomy </h2></div>            
		...
		<div class="off-sidebar-content offcanvas-scroll auto-scroll">
    		<form class="needs-validation" novalidate>
                <div class="form-group row align-items-center mb-3">
                    <div class="col-lg-12">
                        <label class="text-capitalize form-control-label d-flex justify-content-lg-start">Taxonomy Slug <span class="text-danger"> *</span></label>	                          
                ...
                <div class="form-group row align-items-center mb-3">
                    <div class="col-lg-12">
                        <label class="text-capitalize form-control-label d-flex justify-content-lg-start">Select Post Type <span class="text-danger">*</span></label>
                ...
                <div class="form-group row mb-5">
                    <div class="col-lg-12">
                        <label class="text-capitalize form-control-label d-flex justify-content-lg-start">Is Hierarchical</label>
                        <div class="row">
                            <div class="col-lg-2">
